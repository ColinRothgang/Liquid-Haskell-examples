...
Proof. now unshelve refine (forall (n:{n: Natural| True}), (` (add (injectionCast Natural (fun m: Natural => True) (fun m: Natural => I) (ZeroN)) n))=(` (n))).
Defined.
...
Proof. now unshelve refine (forall (m:{m: Natural| True}) (n:{n: Natural| True}), Suc (` (add m n))=(` (add (injectionCast Natural (fun m: Natural => True) (fun m: Natural => I) (Suc (` (m)))) n))).
Defined.
...
Proof. now unshelve refine (forall (n:{n: Natural| True}), (` (add n (injectionCast Natural (fun n: Natural => True) (fun n: Natural => I) (ZeroN))))=(` (n))).
Defined.
...
Proof. now unshelve refine (forall (n:{n: Natural| True}), (` (mult (injectionCast Natural (fun m: Natural => True) (fun m: Natural => I) (one)) n))=(` (n))).
Defined.
...
Proof. now unshelve refine (forall (m:{m: Natural| True}) (n:{n: Natural| True}), Suc (` (add m n))=(` (add m (injectionCast Natural (fun n: Natural => True) (fun n: Natural => I) (Suc (` (n))))))).
Defined.
...
Proof. now unshelve refine (forall (n:{n: Natural| True}) (m:{m: Natural| True}), (` (mult n (injectionCast Natural (fun n: Natural => True) (fun n: Natural => I) (Suc (` (m))))))=(` (add n (subsumptionCast Natural (fun VV: Natural => (` (mult_unrefined m n))=VV) (fun n: Natural => True) _ (mult n m))))).
Defined.
...
Proof. now unshelve refine (forall (n:{n: Natural| True}), (` (mult (injectionCast Natural (fun m: Natural => True) (fun m: Natural => I) (ZeroN)) n))=ZeroN).
Defined.
...
Proof. now unshelve refine (forall (m:{m: Natural| True}) (n:{n: Natural| True}), (` (mult (injectionCast Natural (fun m: Natural => True) (fun m: Natural => I) (Suc (` (m)))) n))=(` (add n (subsumptionCast Natural (fun VV: Natural => (` (mult_unrefined m n))=VV) (fun n: Natural => True) _ (mult m n))))).
Defined.
...
Proof. now unshelve refine (forall (n:{n: Natural| True}), (` (mult n (injectionCast Natural (fun n: Natural => True) (fun n: Natural => I) (ZeroN))))=ZeroN).
Defined.
...
Proof. now unshelve refine (forall (n:{n: Natural| True}), (` (mult n (injectionCast Natural (fun n: Natural => True) (fun n: Natural => I) (one))))=(` (n))).
Defined.
